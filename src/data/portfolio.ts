...
export const personalInfo: PersonalInfo = {
  ...
  photo: '/harena.jpg',
  summary: {
    en: 'Lead Mobile & Web Developer with 3.5+ years of expertise at Futurmap. Specialized in Flutter development with strong command of modern web technologies (Node.js, Vue.js, Django, Next.js). Expert in GIS solutions and complex geospatial system integration.',
    fr: "Lead Développeur mobile et web expérimenté avec plus de 3 ans et demi d'expertise chez Futurmap. Spécialisé en développement Flutter avec une solide maîtrise des technologies web modernes (Node.js, Vue.js, Django, Next.js). Expert en solutions SIG et intégration de systèmes géospatiaux complexes.",
  },
...
export const skillCategories: Record<Skill['category'], { en: string; fr: string; color: string }> = {
...
export const projects: Project[] = [
  ...
  },
  {
    ...
    technologies: ['Django', 'Next.js', 'Python', 'TypeScript', 'WebSocket', 'Leaflet', 'OpenStreetMap', 'PostgreSQL', 'QGIS'],
    featured: true,
  },
  {
    id: 'ticketing',
